-- ============================================================
-- FORCE KARATE — Script de manipulación y consultas
-- Archivo: datos_consultas_319024019028.sql
-- Incluye: INSERTs (5 por tabla), 3 UPDATE, 3 DELETE, 5 SELECT
-- ============================================================
...
SET Activa = 0
WHERE Id_Alumno = 4 AND Tipo = 'Lesión ligamento rodilla derecha';
...
GROUP BY c.Id_Categoria, c.Nombre, c.Cuota_Mensual
