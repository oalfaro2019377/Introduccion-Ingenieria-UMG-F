...
ALTER TABLE Alumno_319024019028
  ADD CONSTRAINT fk_alumno_categoria_319024019028 FOREIGN KEY (Id_Categoria) REFERENCES Categoria_319024019028 (Id_Categoria);

-- Alumno > Padre
ALTER TABLE Alumno_319024019028
  ADD CONSTRAINT fk_alumno_padre_319024019028 FOREIGN KEY (Id_Padre) REFERENCES Padre_319024019028 (Id_Padre);

-- Alumno > Seguro Médico
ALTER TABLE Alumno_319024019028 ADD CONSTRAINT fk_alumno_seguro_319024019028 FOREIGN KEY (Id_Seguro) REFERENCES Seguro_Medico_319024019028 (Id_Seguro);

-- Condición Médica > Alumno
ALTER TABLE Condicion_Medica_319024019028
  ADD CONSTRAINT fk_condicion_alumno_319024019028 FOREIGN KEY (Id_Alumno) REFERENCES Alumno_319024019028 (Id_Alumno);

-- Pago > Alumno
ALTER TABLE Pago_319024019028
  ADD CONSTRAINT fk_pago_alumno_319024019028 FOREIGN KEY (Id_Alumno) REFERENCES Alumno_319024019028 (Id_Alumno);
